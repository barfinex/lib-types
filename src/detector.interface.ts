 ...
 */
export type DetectorListItem = Detector & { status: DetectorStatus };
...
export const DetectorEventGroups: Record<DetectorEventCategory, DetectorEventType[]> = {
    ...
    metrics: [
        ...
        DetectorEventType.INDICATOR_UPDATED,
        DetectorEventType.PERFORMANCE_SNAPSHOT,
        DetectorEventType.QUALITY_GATE_STATE,
        DetectorEventType.RISK_CONTEXT_UPDATED,
        DetectorEventType.DECISION_CONTEXT_UPDATED
    ],
    infrastructure: [
